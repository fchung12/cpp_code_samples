...
//include vector type for GzShade helper function
#include <vector>
using namespace std;
...
public:
	...
	//HW6 anti-alias offset shifts intialized to 0
	float Xoffset = 0.0;
	float Yoffset = 0.0;
	float weight = 1.0; //anti-aliasing weight initialized to 1 to do nothing
	...
	vector<float> GzShade(vector<float> normal);
